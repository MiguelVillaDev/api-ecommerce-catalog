...
import com.project.catalogo.infrastructure.adapter.out.persistence.entity.ProductEntity;
import com.project.catalogo.infrastructure.adapter.out.persistence.repository.ProductRepository;
import com.project.catalogo.infrastructure.mapper.ProductMapper;
    ...
    public ProductModel findByID(ProductModel productModel){
        ProductEntity entity = productRepository.findById(productModel.getId())
                .orElseThrow(() -> new EntityNotFoundException(
                        "Product no existe con id: " + productModel.getId()
                ));
